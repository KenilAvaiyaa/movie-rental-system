...
from .views import signup_view, movie_list_view, rent_movie_view, return_movie_view, get_user_rented_movies, logout_view,check_auth
...
urlpatterns = [
    ...
    path('rented-movies/', get_user_rented_movies, name='user-rented-movies'),
